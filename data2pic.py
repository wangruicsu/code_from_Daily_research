...
#    plt.axis([0, 500, -9, 7])
    ...
    plt.xticks(fontsize=15)
    plt.yticks(fontsize=15)
    I_proposed = plt.plot(t1, df['bat_I'].values, 'g--', t1, df['SC_I'].values, 'r--',linewidth=2)
...
def draw_6(NYCC_df,LA92_df):
    ...
    plt.xticks(fontsize=15)
    plt.yticks(fontsize=15)
    I = plt.plot(t1, df['LA92  speed[km/h]'].values, 'g', t1, df['NYCC  speed[km/h]'].values, 'r--',linewidth=3)
#    ax1.set_xlabel('Time', fontsize=20)
    ...
    plt.xticks(fontsize=15)
    plt.yticks(fontsize=15)
    SC_SOC = plt.plot(t1, df['LA92  power[kw]'].values, 'g', t1, df['NYCC  power[kw]'].values, 'r--',linewidth=3)
...
#    draw_7_8(LA92_df)
    ...
    #验证I_Load*V_bus = EVPower
#    draw_7_8(LA92_df)
#    t1 = np.arange(0, 500, 0.1)
#    plt.plot( t1,LA92_df['I_Load'].values * 24,t1,LA92_df['EVPower'].values)
    
#    print(LA92_df['I_Load'].values - LA92_df['I_Load.1'].values)
#    
#    v_bus_set = 24 * np.ones( (5000,1), dtype=np.int16 )
#    print(LA92_df['bat_V'].values / 24)
#    
#    plt.figure(figsize = (15,5))
#
#    # 代码中的“...”代表省略的其他参数
